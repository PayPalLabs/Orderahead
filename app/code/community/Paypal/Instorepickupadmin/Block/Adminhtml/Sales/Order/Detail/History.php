 ...
 *
 */
class Paypal_Instorepickupadmin_Block_Adminhtml_Sales_Order_Detail_History extends Mage_Adminhtml_Block_Sales_Order_View_Tab_History
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('paypal/instorepickupadmin/sales/order/detail/history.phtml');
    }
